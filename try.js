...
// Define the function to handle the report button click
...
//working na may console log
// function handleReportButtonClick() {
//     // Find the list item corresponding to the scanned QR code
//     const listItem = document.querySelector('#idList li');

//     // Extract the ID, driverName, driverPlateNumber, and requestBy from the list item
//     if (listItem) {
